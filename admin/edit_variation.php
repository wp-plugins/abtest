...
$exp = $wpdb->get_row($wpdb->prepare('SELECT * FROM wp_abtest_experiments WHERE id=%d', $var->experiment_id));
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $wpdb->query($wpdb->prepare('UPDATE wp_abtest_variations SET name=%s, content=%s WHERE id=%d', $name, $content, $id));
